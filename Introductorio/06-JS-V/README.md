...
Ahora todo Alumno del curso antes de Alumno es una Persona, asique podríamos decir que un Alumno hereda las propiedades de ser Persona.
...
Completa la tarea descrita en el archivo [README](./homework)
