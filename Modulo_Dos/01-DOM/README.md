...
```javascript
    const a = document.querySelector('#linkEjemplo'); // Obtengo el elemento a cuyo id es 'linkEjemplo'

    a.setAttribute('href', 'https://example.com/'); // Seteo el atributo href del elemento a para que redireccione a la página principal de ejemplo

    a.href = 'https://example.com/'; // Equivalente al anterior pero más corto
```
