...
Luego, vamos a crear la variable que va a tener el texto que queremos que se reemplaze en nuestro template. Por ejemplo: `var nombre = 'Mi Curso'`.
...
http.createServer( function(req, res){ 
 ...
 var nombre = 'Mi Curso'; //Esta es la variable con la que vamos a reemplazar el template
...
Completa la tarea descrita en el archivo [README](./homework/Beatles)
